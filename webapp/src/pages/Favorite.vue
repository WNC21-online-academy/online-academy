<template>
  <Grid title="Khóa học yêu thích" :list="state.courses" :totalPages="+totalPages" :currentPage="+currentPage" />
</template>
...
import { fetchAllByWatchlist } from '../services/courses.service'
...
async function searchCourses() {
  const searchResult = await fetchAllByWatchlist({
    limit: perPage,
