<template>
  <div class="max-w-6xl mx-auto">
    <div class="flex items-center justify-center">
      <div class="max-w-sm w-full sm:w-full lg:w-full">
        <div class="bg-white shadow-xl rounded-lg overflow-hidden">
          <div class="bg-cover bg-center h-56 p-4" :style="{ backgroundImage: `url('${item.thumbnail}')` }">
          ...
          <div class="p-4">
            ...
            <p class="text-3xl text-gray-900">{{ item.tutition }} đ</p>
          ...
          <div class="px-4 pt-3 pb-4 border-t border-gray-300 bg-gray-100">
            ...
            <div class="flex items-center pt-2">
              <div
                ...
                style="background-image: url(https://via.placeholder.com/50x50)"
              ></div>
              <div>
