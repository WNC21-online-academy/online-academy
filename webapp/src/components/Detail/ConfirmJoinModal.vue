...
import { joinCourse } from '../../services/courses.service';
...
// emit events
const emit = defineEmit(['toggleModal', 'onJoined'])
...
async function onSubmit() {
  ...
  await emit('onJoined', result.id_course)
  onToggleModal(false)
}
