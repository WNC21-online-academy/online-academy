    ...
    <div class="container px-5 py-24 mx-auto">
      <div class="lg:w-4/5 mx-auto flex flex-wrap">
        ...
        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          <h2 class="text-sm title-font text-gray-500 tracking-widest">KHÓA HỌC</h2>
          <h1 class="text-white text-3xl title-font font-medium mb-1">{{ detail.name }}</h1>
          <div class="flex mb-4">
            <span class="flex items-center">
              ...
              <span class="ml-3">4 Đánh giá</span>
            </span>
          ...
          <div class="flex">
            ...
            >{{ Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(detail.tutition) }}</span>
            <button
