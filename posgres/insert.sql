...
VALUES (1, 1, 1, 'Giới thiệu javasript', '', '/assets/videos/1-1.mp4'),
  (2, 1, 2, 'Công cụ', '', '/assets/videos/1-2.mp4'),
  (3, 1, 3, 'Cú pháp', '', '/assets/videos/1-3.mp4'),
  (4, 2, 1, 'Giới thiệu html', '', '/assets/videos/1-1.mp4'),
  (5, 2, 2, 'Giới thiệu css', '', '/assets/videos/1-2.mp4'),
  (6, 2, 3, 'Công cụ lập trình', '', '/assets/videos/1-3.mp4'),
  (7, 2, 4, 'Cắt psd', '', '/assets/videos/1-1.mp4'),
  (8, 3, 1, 'Giới thiệu', '', '/assets/videos/1-1.mp4'),
  (9, 3, 2, 'Cài đặt môi trường', '', '/assets/videos/1-2.mp4'),
  (10, 3, 3, 'Cú pháp', '', '/assets/videos/1-3.mp4'),
  (11, 4, 1, 'Giới thiệu', '', '/assets/videos/1-1.mp4'),
  (12, 4, 2, 'Biến, hằng, kiểu dữ liệu', '', '/assets/videos/1-2.mp4'),
  (13, 5, 1, 'Ôn lại Vue 2', '', '/assets/videos/1-1.mp4'),
  (14, 5, 2, 'Vue 3 có gì mới', '', '/assets/videos/1-2.mp4'),
  (15, 5, 3, 'Option Api', '', '/assets/videos/1-3.mp4'),
  (16, 5, 4, 'Composition Api', '', '/assets/videos/1-2.mp4'),
  (17, 5, 5, 'Code dự án thực tế', '', '/assets/videos/1-3.mp4'),
  (18, 6, 1, 'Giới thiệu javasript', '', '/assets/videos/1-1.mp4'),
  (19, 6, 2, 'Công cụ', '', '/assets/videos/1-2.mp4'),
  (20, 6, 3, 'Cú pháp', '', '/assets/videos/1-3.mp4'),
  (21, 7, 1, 'Giới thiệu html', '', '/assets/videos/1-1.mp4'),
  (22, 7, 2, 'Giới thiệu css', '', '/assets/videos/1-2.mp4'),
  (23, 7, 3, 'Công cụ lập trình', '', '/assets/videos/1-3.mp4'),
  (24, 7, 4, 'Cắt psd', '', '/assets/videos/1-1.mp4'),
  (25, 8, 1, 'Giới thiệu', '', '/assets/videos/1-1.mp4'),
  (26, 8, 2, 'Cài đặt môi trường', '', '/assets/videos/1-2.mp4'),
  (27, 8, 3, 'Cú pháp', '', '/assets/videos/1-3.mp4'),
  (28, 9, 1, 'Giới thiệu', '', '/assets/videos/1-1.mp4'),
  (29, 9, 2, 'Biến, hằng, kiểu dữ liệu', '', '/assets/videos/1-2.mp4'),
  (30, 10, 1, 'Giới thiệu javasript', '', '/assets/videos/1-1.mp4'),
  (31, 10, 2, 'Công cụ', '', '/assets/videos/1-2.mp4'),
  (32, 10, 3, 'Cú pháp', '', '/assets/videos/1-3.mp4'),
  (33, 11, 1, 'Giới thiệu html', '', '/assets/videos/1-1.mp4'),
  (34, 11, 2, 'Giới thiệu css', '', '/assets/videos/1-2.mp4'),
  (35, 11, 3, 'Công cụ lập trình', '', '/assets/videos/1-3.mp4'),
  (36, 11, 4, 'Cắt psd', '', '/assets/videos/1-1.mp4'),
  (37, 12, 1, 'Giới thiệu', '', '/assets/videos/1-1.mp4'),
  (38, 12, 2, 'Cài đặt môi trường', '', '/assets/videos/1-2.mp4'),
  (39, 12, 3, 'Cú pháp', '', '/assets/videos/1-3.mp4'),
  (40, 13, 1, 'Giới thiệu', '', '/assets/videos/1-1.mp4'),
  (41, 13, 2, 'Biến, hằng, kiểu dữ liệu', '', '/assets/videos/1-2.mp4'),
  (42, 14, 1, 'Giới thiệu javasript', '', '/assets/videos/1-1.mp4'),
  (43, 14, 2, 'Công cụ', '', '/assets/videos/1-2.mp4'),
  (44, 14, 3, 'Cú pháp', '', '/assets/videos/1-3.mp4'),
  (45, 15, 1, 'Giới thiệu html', '', '/assets/videos/1-1.mp4'),
  (46, 15, 2, 'Giới thiệu css', '', '/assets/videos/1-2.mp4'),
  (47, 15, 3, 'Công cụ lập trình', '', '/assets/videos/1-3.mp4'),
  (48, 15, 4, 'Cắt psd', '', '/assets/videos/1-1.mp4'),
  (49, 16, 1, 'Giới thiệu', '', '/assets/videos/1-1.mp4'),
  (50, 16, 2, 'Cài đặt môi trường', '', '/assets/videos/1-2.mp4'),
  (51, 16, 3, 'Cú pháp', '', '/assets/videos/1-3.mp4'),
  (52, 17, 1, 'Giới thiệu', '', '/assets/videos/1-1.mp4'),
  (53, 17, 2, 'Biến, hằng, kiểu dữ liệu', '', '/assets/videos/1-2.mp4'),
  (54, 18, 1, 'Giới thiệu javasript', '', '/assets/videos/1-1.mp4'),
  (55, 18, 2, 'Công cụ', '', '/assets/videos/1-2.mp4'),
  (56, 18, 3, 'Cú pháp', '', '/assets/videos/1-3.mp4'),
  (57, 19, 1, 'Giới thiệu html', '', '/assets/videos/1-1.mp4'),
  (58, 19, 2, 'Giới thiệu css', '', '/assets/videos/1-2.mp4'),
  (59, 19, 3, 'Công cụ lập trình', '', '/assets/videos/1-3.mp4'),
  (60, 19, 4, 'Cắt psd', '', '/assets/videos/1-1.mp4'),
  (61, 20, 1, 'Giới thiệu', '', '/assets/videos/1-1.mp4'),
  (62, 20, 2, 'Cài đặt môi trường', '', '/assets/videos/1-2.mp4'),
  (63, 20, 3, 'Cú pháp', '', '/assets/videos/1-3.mp4'),
  (64, 21, 1, 'Giới thiệu', '', '/assets/videos/1-1.mp4'),
  (65, 21, 2, 'Biến, hằng, kiểu dữ liệu', '', '/assets/videos/1-2.mp4');
