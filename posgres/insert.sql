...
VALUES
  ...
  (3, 15, 2, 'Wordpress 2021', 'Công cụ xây dựng website nhanh', 'WordPress là một Hệ quản trị nội dung Mã nguồn mở miễn phí viết bằng ngôn ngữ lập trình PHP cùng với cơ sở dữ liệu MySQL hoặc MariaDB. WordPress là hậu duệ chính thức của b2/cafelog.', 'https://www.semtek.com.vn/wp-content/uploads/2020/08/t%E1%BA%A1o-Website-tin-t%E1%BB%A9c-b%E1%BA%B1ng-Wordpress-2.jpg', 1800000),
  (4, 16, 2, 'Google Flutter', 'Phát triển ứng dụng di động đa nền tảng', 'Flutter là một SDK phát triển ứng dụng di động nguồn mở được tạo ra bởi Google. Nó được sử dụng để phát triển ứng ứng dụng cho Android và iOS, cũng là phương thức chính để tạo ứng dụng cho Google Fuchsia', 'https://colaninfofactors.com/wp-content/uploads/2019/01/FlutterBanner.png', 2500000),
  (5, 17, 2, 'Unity 2021', 'Xây dựng game 3D', 'Unity là một game engine đa nền tảng được phát triển bởi Unity Technologies, mà chủ yếu để phát triển video game cho máy tính, consoles và điện thoại. Lần đầu tiên nó được công bố chạy trên hệ điều hành OS X, tại Apple s Worldwide Developers Conference vào năm 2005, đến nay đã mở rộng 27 nền tảng.', 'https://taap.vn/upload/r/news/1%20tuyen%20unity.jpg', 3200000),
  (6, 18, 2, 'Machine Learning 2021', 'Một tập con của AI', 'Học máy là một lĩnh vực của trí tuệ nhân tạo liên quan đến việc nghiên cứu và xây dựng các kĩ thuật cho phép các hệ thống "học" tự động từ dữ liệu để giải quyết những vấn đề cụ thể. Ví dụ như các máy có thể "học" cách phân loại thư điện tử xem có phải thư rác hay không và tự động xếp thư vào thư mục tương ứng.', 'http://dotnetguru.org/wp-content/uploads/2018/12/machine-learning-va-ai.jpg', 2800000),
  (7, 19, 2, 'PostgreSQL 2021', 'Hệ QTCSDL quan hệ', 'PostgreSQL là một hệ quản trị cơ sở dữ liệu quan hệ và đối tượng dựa trên POSTGRES, bản 4.2, được khoa điện toán của đại học California tại Berkeley phát triển. POSTGRES mở đường cho nhiều khái niệm quan trọng mà các hệ quản trị dữ liệu thương mại rất lâu sau mới có.', 'http://sqladvice.com/wp-content/uploads/2020/08/tinh-nang-cua-postgresql.png', 1200000),
  (8, 20, 2, 'Selenium 2021', 'Công cụ kiểm thử tự động', 'Selenium là bộ kiểm thử tự động miễn phí (mã nguồn mở) dành cho các ứng dụng web trên các trình duyệt và nền tảng khác nhau. Nó khá là giống với HP Quick Test Pro (QTP bây giờ là UFT) chỉ khác là Selenium thì tập trung vào việc tự động hoá các ứng dụng dựa trên nền tảng web. Kiểm thử được thực hiện bằng cách sử dụng công cụ Selenium thường được gọi là Kiểm thử Selenium. Selenium không chỉ là 1 công cụ độc lập mà là 1 bộ công cụ của phần mềm, mỗi bộ đều đáp ứng được nhu cầu kiểm thử khác nhau của 1 tổ chức.', 'https://ec30.org/wp-content/uploads/2017/01/selenium-chart.png', 1400000),
  (9, 21, 2, 'An toàn mạng 2021', 'Ngăn chặn xâm nhập trái phép trên đường truyền mạng', 'Bảo mật mạng là tập hợp các hình thức, công cụ, thiết bị, chương trình được doanh nghiệp sử dụng nhằm mục đích bảo vệ tính riêng tư và an toàn cho những thông tin. Bảo mật mạng giúp hạn chế khả năng truy cập, sửa đổi và đánh cắp dữ liệu từ những cá nhân hoặc tổ chức khác.', 'https://i2.wp.com/1.bp.blogspot.com/-ggRh-2-uGws/XPgZ3Z9GEgI/AAAAAAAABmY/pM8ZbI1evs8m26r5UChIOHaMC8AHeu4ygCLcBGAs/s1600/X5gFB1559764843.png', 1200000),
  (10, 22, 2, 'Linux', 'Quản lý linux server', 'Linux đã đã cho thấy sự tiến bộ vượt bậc so với một thập kỷ trước, nâng bản thân nó từ một hệ điều hành mã nguồn mở trở nên thực sự hữu dụng với mọi người. Nhiều người đã quay lưng lại với Windows để đến với các bản phân phối miễn phí của Linux.', 'https://thietbiketnoi.com/wp-content/uploads/2019/11/linux-la-gi-he-dieu-hanh-ma-nguon-mo.jpg', 1000000),
  (11, 23, 2, 'Golang 2021', 'Ngôn ngữ mã nguồn mở của Google', 'Go là một ngôn ngữ lập trình mới do Google thiết kế và phát triển. Nó được kỳ vọng sẽ giúp ngành công nghiệp phần mềm khai thác nền tảng đa lõi của bộ vi xử lý và hoạt động đa nhiệm tốt hơn.', 'https://matobnews.b-cdn.net/wp-content/uploads/2020/11/go.png', 2000000),
  (12, 24, 2, 'Cấu trúc dữ liệu', 'Rất quan trọng trong mọi khía cạnh của lập trình', 'Trong khoa học máy tính, cấu trúc dữ liệu là một cách lưu dữ liệu trong máy tính sao cho nó có thể được sử dụng một cách hiệu quả. Trong thiết kế nhiều loại chương trình, việc chọn cấu trúc dữ liệu là vấn đề quan trọng.', 'http://zephyrfalcon.org/wp-content/uploads/2020/09/cau-truc-giai-thuat-la-gi.png', 1200000),
  (13, 25, 2, 'Kiến trúc Microservices', 'Một biến thể của kiến trúc hướng dịch vụ (SOA)', 'Microservice là một kỹ thuật phát triển phần mềm, một biến thể của kiến trúc hướng dịch vụ cấu trúc một ứng dụng như một tập hợp các dịch vụ được ghép lỏng lẻo. Trong kiến trúc microservice, các dịch vụ được xử lý tốt và các giao thức rất nhẹ.', 'https://bizflyportal.mediacdn.vn/bizflyportal/1455/2428/2021/05/14/15/26/mic16209591662533.jpeg', 1200000)
